...
<script src="<?php echo B_URL; ?>system/js/galleries.js" type="text/javascript"></script>
<link href="<?php echo B_URL; ?>system/css/galleries.css" rel="stylesheet" type="text/css"/>
