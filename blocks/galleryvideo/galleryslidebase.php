...
$myG = $rowg['idGal'];
$rslidet = $database->query("SELECT * FROM image_gal WHERE galId = '$myG'");
$rowts = array();
        ...
        <div class="galleryShow">
            ...
            <div class="col-md-6">
                <div class="controls">        
                    ...
                    <a class="play"><img src="<?php echo B_URL; ?>system/img/play.png" /></a>
                    <a class="pause"><img src="<?php echo B_URL; ?>system/img/pause.png" /></a> 
