...
<script src="<?php echo B_URL; ?>system/js/multimedia.js" type="text/javascript"></script>
<link href="<?php echo B_URL; ?>system/css/multimedia.css" rel="stylesheet" type="text/css"/>
<link rel="Stylesheet" type="text/css" href="<?php echo B_URL; ?>system/css/smoothDivScroll.css" />
<script src="<?php echo B_URL; ?>system/js/jquery.mousewheel.min.js" type="text/javascript"></script>
<script src="<?php echo B_URL; ?>system/js/jquery.kinetic.min.js" type="text/javascript"></script>
<script src="<?php echo B_URL; ?>system/js/jquery.smoothdivscroll-1.3-min.js" type="text/javascript"></script>	
<script src="<?php echo B_URL; ?>system/js/jquery.colorbox-min.js" type="text/javascript"></script>		
