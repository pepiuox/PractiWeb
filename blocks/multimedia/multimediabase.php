<div class="col-md-12">
    <div class="galleryShow">
        <?php
        $rslideg = $database->query("SELECT idGal, title, description, pageId FROM galleries WHERE active='1' AND pageId = '$bid' LIMIT 1");
        ...
        <div class="galleryContainer">                 
            <div class="galleryThumbnailsContainer">
                <div class="galleryThumbnails scrollpanel">
                    <?php
                    $rslidet = $database->query("SELECT id, galId, image FROM multimedia_gal WHERE galId = '$idGal'");
            ...
            <div class="galleryPreviewContainer">
                <div class="galleryPreviewImage">  
                    <ul>
                        <?php
                        $rslider = $database->query("SELECT id, galId, description, source, idlink FROM multimedia_gal WHERE galId = '$idGal'");
...
<script src="<?php echo B_URL; ?>system/js/plyr.js" type="text/javascript"></script>
<script>
                    plyr.setup();
</script>