...
<script src="<?php echo B_URL; ?>system/js/slidegallery.js" type="text/javascript"></script>
<link href="<?php echo B_URL; ?>system/css/slidegallery.css" rel="stylesheet" type="text/css"/>
