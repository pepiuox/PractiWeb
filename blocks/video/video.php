<!-- video block -->
<?php
$rslider = $database->query("SELECT idVd, pageId, description, source, idlink FROM videos WHERE active='1' AND pageId = '$bid' LIMIT 1");
$rows = array();
            ...
            <div class="col-md-12">
                <div class="galleryContainer">                             
                    ...
                    <div class="galleryContent">
                        ...
                        <?php
                        if ($row['description'] == '') {
                            $crow = mysqli_fetch_array($database->query("SELECT * FROM `page` WHERE `id` = '$bid' "));
                            echo $crow['content'];
                        } else {
