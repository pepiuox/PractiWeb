        ...
        <div class="row">
             ...
             */ else if (isset($_SESSION['regsuccess'])) {
                ...
                if ($_SESSION['regsuccess']) {
                    echo "<h1>Registered!</h1>";
                    if (EMAIL_WELCOME) {
                        echo "<p>Gracias <b>" . $_SESSION['reguname'] . "</b>, you have been sent a confirmation email which should be arriving shortly.  Please confirm your registration before you continue.<br />Volver a <a href='main.php'>Principal</a></p>";
                    } else {
