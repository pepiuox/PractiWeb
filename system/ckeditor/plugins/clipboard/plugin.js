...
( function() {
	...
	function initDragDrop( editor ) {
		...
		editor.on( 'contentDom', function() {
			...
			editable.attachListener( dropTarget, 'drop', function( evt ) {
				...
				// The <html class="no-js" lang="en"> tag isn't editable (body is), but we want to allow drop on it
	...
	CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
		...
		getData: function( type ) {
			...
			// or surround it with <html class="no-js" lang="en"><head>...</head><body>(some content)<!--StartFragment--> and <!--EndFragment-->(some content)</body></html>
