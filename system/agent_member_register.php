    ...
    <div class="container">
        <main class="main">
            <div class="row">
                 ...
                 */
                if (($session->logged_in) && ($session->isAgMember())) {
                    ?>

                    <h2>Agregar un Miembro al Grupo</h2>
                    <?php
                    if ($form->num_errors > 0) {
                        echo "<td><font size=\"2\" color=\"#ff0000\">" . $form->num_errors . " error(s) encontrados</font></td>";
                    }
                    ?>
                    <form action="process.php" method="POST">
                        <table align="left" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr><td></td><td align="right"><input type="hidden" name="member_subjoin" value="1"><input type="submit" value="Add Agente Miembro!"></td><td></td></tr>
