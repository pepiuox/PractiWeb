        ...
        <tbody>
            ...
            for ($index = 0; $index < $indexCount; $index++) {
                ...
                if (substr("$dirArray[$index]", 0, 1) != $hide) {
                    ...
                    echo "
          <tr class='$class'>
            <td><a class='selimg' href='http://localhost:815/upload/$namehref'>$name</a></td>
            <td><a href='http://localhost:815/upload/$namehref'>$extn</a></td>
            <td><a href='http://localhost:815/upload/$namehref'>$size</a></td>
            <td sorttable_customkey='$timekey'><a href='http://localhost:815/upload/$namehref'>$modtime</a></td>
          </tr>";
                }
            }
            ?>
